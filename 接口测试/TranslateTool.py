# !/usr/bin/env python3
# -*- coding:utf-8 -*-
# 中山二院  志明  2019-05-13 15:38
# 当前计算机登录名称 :andy
# 项目名称  :
# 编译器   :PyCharm
__author____ = '志明'
__time__ = '2019-05-13 15:38'
...
if __name__ == "__main__":
    # print(translate_func("Cleaning up the connection ''{0}''."))
    print(baidu_translate("Cleaning up the connection ''{0}''."))
